...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KW_EXECUTION = 4,               /* KW_EXECUTION  */
  YYSYMBOL_KW_SEND = 5,                    /* KW_SEND  */
  YYSYMBOL_KW_FROM = 6,                    /* KW_FROM  */
  YYSYMBOL_KW_TO = 7,                      /* KW_TO  */
...
#line 39 "src/grammar.ypp"
     ...
     block->setFromRank(std::stoi(yyvsp[-3]));
